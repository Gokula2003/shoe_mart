    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="category" 
                        ...
                        <option value="Skateboard" {{ old('category') == 'Skateboard' ? 'selected' : '' }}>Skateboard</option>
                        <option value="Walking" {{ old('category') == 'Walking' ? 'selected' : '' }}>Walking</option>
            ...
            <div class="flex space-x-4">
                <button type="submit" 
                        style="background-color: #16a34a !important; color: white !important; padding: 12px 24px; font-size: 16px; font-weight: 600; border: none; border-radius: 6px; cursor: pointer;">
                    Create Product
                </button>
