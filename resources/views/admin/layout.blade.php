            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="ml-10 flex items-center space-x-2">
                        ...
                        <a href="{{ route('admin.contact-messages.index') }}" class="nav-link-admin text-white/90 hover:text-white px-4 py-2 rounded-lg hover:bg-white/10 transition-all font-medium flex items-center space-x-2">
