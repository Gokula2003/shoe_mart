            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-700 mb-6">
                        ...
                        with an order, or just want to say hello, feel free to reach out.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">123 Shoe Street<br>Fashion District<br>New York, NY 10001</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">info@shoemart.com</p>
                                <p class="text-gray-700">support@shoemart.com</p>
                            </div>
                        </div>
                    </div>
